...
export class RoleService {
  ...
  async updateRole(id: string, name: string, successCallBack?: () => void, errorCallBack?: (error) => void) {
  ...
  async deleteRole(id: string, successCallBack?: () => void, errorCallBack?: (error) => void) {
